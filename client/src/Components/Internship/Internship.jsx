...
export default function Interns() {
  ...
  return (
    ...
    <div id="internship-image">
        {interns.map((intern)=>{
          return <InternCard company_img={intern.company_img} intern_id={intern.intern_id} title={intern.title} dept={intern.department} batch_year={intern.batch_year} apply_now={intern.offcial_link} date={intern.deadline.slice(0,10)}/>
        })}
        <Footer />
      </div>
      // {
