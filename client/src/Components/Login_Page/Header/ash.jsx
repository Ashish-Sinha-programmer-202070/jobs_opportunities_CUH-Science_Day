  ...
  return (
    <header className="Header">
      ...
      <nav className="Nav">
        ...
        <a  className="Box" href="/"> <Link to='/internship'>Internships</Link></a>
        ...
        <a  className="Box" href="/"><Link to='/contact' style={{TextDecoration: 'none'}}>ContactUS</Link></a>
        <div className="button">
        <button className="button button2"><Link to='/front'>Login</Link> </button>
