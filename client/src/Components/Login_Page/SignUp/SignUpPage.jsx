...
const SignUpPage = () => {
  ...
  const handleSignUP = async () => {
    ...
    if (
      ...
      alert(
        "Passwords didn't match. Please Enter same password in both fields."
      );
      return false;
  ...
  return (
    <div className="signup-page-container">
      <div className="signup-page">
        <img src={signup_img} alt="women_signing_up"  className="cuh_logoSign"/>
        <div className="signup-form">
          ...
          >
            ...
            <input
              value={skill}
              onChange={(e) => {
                setskill(e.target.value.toLocaleLowerCase());
              }}
              type="text"
              name="skill"
              id="skill"
